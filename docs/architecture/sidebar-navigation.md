...
CCResDoc uses the public navigation surface in `@takazudo/zudo-doc` 5.7.0.
...
zudo-doc 5.7.0 exposes the sidebar as native links and disclosure buttons. The
...
5.7.0 public island contract and should be addressed upstream rather than in a
host wrapper.
