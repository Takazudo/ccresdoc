...
- The published toolchain is `@takazudo/zfb*` `2.20.2` plus `@takazudo/zudo-doc` `5.27.0`; the app and compatibility fixture are validated from their own frozen lockfiles.
