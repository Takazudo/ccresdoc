...
- **Published toolchain**: `@takazudo/zfb@2.20.2` plus native carrier packages
  (the host resolves the matching package-root `zfb` binary) and
  `@takazudo/zudo-doc@5.27.0` (components)
...
`2.20.2`; zudo-doc is pinned to `5.27.0`. Reachable runtime peers are pinned to
