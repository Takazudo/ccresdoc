...
- **Published toolchain**: `@takazudo/zfb@2.16.0` plus native carrier packages
  (the host resolves the matching package-root `zfb` binary) and
  `@takazudo/zudo-doc@5.19.0` (components)
...
`2.16.0`; zudo-doc is pinned to `5.19.0`. Reachable runtime peers are pinned to
