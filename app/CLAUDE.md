...
- **Published toolchain**: `@takazudo/zfb@2.18.0` plus native carrier packages
  (the host resolves the matching package-root `zfb` binary) and
  `@takazudo/zudo-doc@5.25.0` (components)
...
`2.18.0`; zudo-doc is pinned to `5.25.0`. Reachable runtime peers are pinned to
