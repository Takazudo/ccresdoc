...
// localStorage key — matches the original desktop-sidebar-toggle.tsx so that
// pre-paint scripts and other components share the same persisted state.
...
export default function DesktopSidebarToggle() {
  ...
  return (
    <button
      ...
      class="zd-desktop-sidebar-toggle"
