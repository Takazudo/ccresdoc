// Shared constants and primitives for sidebar-tree — ported from the original
// tree-nav-shared.tsx so that CSS class names and layout geometry stay identical.
...
// Chevron icon path for the category link indicator
...
export function ConnectorLines({
  ...
  const width =
    widthScale === 1 ? CONNECTOR_WIDTH : `calc(${CONNECTOR_WIDTH} * ${widthScale})`;
  return (
    <>
      <div
